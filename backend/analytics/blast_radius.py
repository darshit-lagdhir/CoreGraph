...
class BlastRadiusCalculator:
    ...
    def calculate(self):
        ...
        if not nx.is_directed_acyclic_graph(self.graph):
             raise ValueError("Graph matrix contains circular dependencies. DAG property required for BlastRadius.")
        ...
        # This will store the set of all unique packages that depend on a given node (directly or indirectly).
