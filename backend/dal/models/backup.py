...
from sqlalchemy import String, ForeignKey, Integer, BigInteger, LargeBinary, Index, text, func, DateTime, Enum as SQLEnum, Boolean
...
class BackupLedger(Base):
    ...
    backup_type: Mapped[BackupType] = mapped_column(
        SQLEnum(BackupType, name="backup_type_enum"), 
        nullable=False
    )
