...
from sqlalchemy import String, ForeignKey, Float, Integer, LargeBinary, Index, text, func, DateTime, Enum as SQLEnum, Boolean
...
class ExportJob(Base):
    ...
    format: Mapped[ExportFormat] = mapped_column(SQLEnum(ExportFormat, name="export_format_type"), nullable=False)
    status: Mapped[ExportStatus] = mapped_column(
        SQLEnum(ExportStatus, name="export_status_type"), 
    ...
    __table_args__ = (
        Index("ix_export_job_lifecycle", status, started_at.desc()),
    )
