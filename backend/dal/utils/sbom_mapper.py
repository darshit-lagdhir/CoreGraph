...
class SBOMMapper:
    ...
    def map_node_to_cyclonedx(
        self, node_data: Dict[str, Any], risk_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "hashes": [{"alg": "SHA-256", "content": node_data.get("sha256_checksum", "0" * 64)}],
            ...
            "properties": [
                ...
                {
                    "name": "coregraph:maintainer_velocity",
                    "value": str(risk_data.get("v_beh", 0.0)),
                },
                {
                    "name": "coregraph:provenance_root",
                    "value": risk_data.get("merkle_root", "NULL"),
                },
            ],
        }

    def generate_full_bom(
        self, nodes: List[Dict[str, Any]], dependencies: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
        ...
        for d in dependencies:
            bom_deps.append({"ref": d["source_ref"], "dependsOn": [d["target_ref"]]})
