...
def main():
    ...
    if s_total_mb > 150:
        print(
            "FAIL: Image size exceeds the 150MB structural limit for the 16GB hypervisor bounds."
        )  # noqa: E501
        sys.exit(1)
    ...
    if ei < 85.0:
        print(
            "FAIL: Image Efficiency Ratio is below the 85% threshold. Waste bytes detected in multi-stage build."  # noqa: E501
        )
        sys.exit(1)
