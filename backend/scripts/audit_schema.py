...
async def audit_schema_integrity():
    """Golden Master Verification: Comparing the physical relational vault against the SQLAlchemy models."""  # noqa: E501
    ...
    async with engine.connect() as conn:
        ...
        if extra_tables:
            logging.warning(
                f"UNTRACKED_ARTIFACDS: Tables found in DB not in models: {extra_tables}"
            )
